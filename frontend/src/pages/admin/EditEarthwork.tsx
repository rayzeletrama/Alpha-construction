...
export const EditEarthwork = () => {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success("Page Terrassement mise à jour !");
    },
      ...
      <section className="space-y-8">
        <div className="flex justify-between items-center border-t pt-10">
          ...
          <button
            ...
            className="bg-black text-white px-6 py-2 rounded-sm font-bold text-xs flex items-center gap-2 hover:bg-primary transition-all shadow-lg"
          >
            <Plus size={16} /> AJOUTER UNE TECHNIQUE
          </button>
        </div>
